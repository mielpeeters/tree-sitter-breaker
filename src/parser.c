...
static const TSSymbol ts_symbol_map[] = {
  ...
  [anon_sym_hp_cutoff] = anon_sym_hp_cutoff,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('0' <= lookahead && lookahead <= '8')) ADVANCE(151);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
    ...
    case 64:
      ...
      END_STATE();
    case 65:
      ACCEPT_TOKEN(anon_sym_hp_cutoff);
      END_STATE();
    case 66:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(96),
  ...
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(92),
  ...
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sample, 1, .production_id = 17),
